...
import { LogOut, Utensils, Wallet, BarChart3, User, Menu } from 'lucide-react';
import { Sheet, SheetContent, SheetTrigger } from './ui/sheet';
import { projectId } from '../utils/supabase/info';
import { MenuTab } from './student/MenuTab';
import { BudgetTab } from './student/BudgetTab';
import { AnalyticsTab } from './student/AnalyticsTab';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 overflow-auto">
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-8">
          ...
          {activeTab === 'analytics' && (
            <AnalyticsTab transactions={transactions} budget={budget} />
          )}
          {activeTab === 'profile' && (
